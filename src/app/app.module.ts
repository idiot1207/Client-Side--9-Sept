...
import { sampleDataTableComponent } from './sampledatatable/sampledatatable.component';
import {ValueArrayPipe} from './sampledatatable/value-array';
import {CdkTableModule} from '@angular/cdk/table';
import {CdkTreeModule} from '@angular/cdk/tree';
import {CdkDetailRowDirective} from './sampledatatable/cdk-detail-row.directive';
  ...
  imports: [
    ...
    RouterModule.forRoot(
      [
       ...
       {
         path: 'sample',
         component : sampleDataTableComponent,
       }
      ]
    )
  ],
